...
package com.android.settings.screwd.hfm;

import java.io.IOException;

import com.android.settings.screwd.hfm.HfmHelpers;
...
public class FetchHosts {
    ...
    public static void fetch() throws IOException {
        ...
        cmd = cmd + " && cat /etc/hosts[0-9] /etc/hosts.alt > /etc/hosts.tmp" //Merge old & new hosts
                  ...
                  + " && sed -i '1i#ScrewdAndroid\' /etc/hosts.tmp" // Add Screwd Android tag
