...
public class ColorPickerDialog extends Dialog implements
    ...
    public ColorPickerDialog(Context context, int theme, int initialColor,
            int androidColor, int screwdColor) {
        super(context, theme);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        if (item.getItemId() == R.id.palette_screwd) {
            mPalette = PALETTE_SCREWD;
            mColorTransitionAnimator.start();
            return true;
            ...
            return true;
        } else if (item.getItemId() == R.id.reset_screwd) {
            mColorPicker.setColor(mScrewdColor, true);
            return true;
        }
        return false;
    }
